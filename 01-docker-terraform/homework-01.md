...
where a.lpep_pickup_datetime >= '2025-11-01 00:00:00' 
and a.lpep_pickup_datetime < '2025-12-01 00:00:00'
...
Answer:
select a."PULocationID", b."Zone", sum(a.total_amount) 
from green_tripdata a left join taxi_zone_lookup b on a."PULocationID" = b."LocationID" 
where a.lpep_pickup_datetime >= '2025-11-18 00:00:00' 
and a.lpep_pickup_datetime < '2025-11-19 00:00:00' 
...
|--------------+-------------------+--------------------|
| 74.0         | East Harlem North | 9281.919999999996  |
...
Answer:
select a."DOLocationID", b."Zone", max(a.tip_amount) 
from green_tripdata a inner join taxi_zone_lookup b on a."DOLocationID" = b."LocationID" 
where a.lpep_pickup_datetime >= '2025-11-01 00:00:00' 
and a.lpep_pickup_datetime < '2025-12-01 00:00:00' 
and a."PULocationID"=74  
group by a."DOLocationID", b."Zone" 
order by max(a.tip_amount) desc limit 5


+--------------+-------------------+------+
| DOLocationID | Zone              | max  |
|--------------+-------------------+------|
| 74.0         | East Harlem North | 45.0 |
